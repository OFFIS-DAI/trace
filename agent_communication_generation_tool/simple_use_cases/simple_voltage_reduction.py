...
try:
    ...
    send_mail_notification(scenario_description='simple voltage reduction')
except Exception as e:
    send_mail_notification(scenario_description=f'simple voltage reduction, error: {e}', failed=True)
