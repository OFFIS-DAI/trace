...
from agent_communication_generation_tool.description_classes.agent_communication_pattern import DemandResponse, \
    CommunicationMode
...
for communication_mode in [CommunicationMode.UNICAST, CommunicationMode.MULTICAST, CommunicationMode.BROADCAST]:
                ...
                for simbench_code in simbench_codes:
                    for network_description_class in network_description_classes:
                        ...
                        for specification in specifications:
                            ...
                            demand_response_comm_pattern = DemandResponse(simulation_duration_ms=SIMULATION_DURATION_MS,
                                                                          communication_graph=communication_graph,
                                                                          reply_after_range=reply_after_times,
                                                                          communication_mode=communication_mode)
                            communication_scenario_description = (
                                CommunicationScenarioDescription(
                                    description_text=f'demand_response_mode_{communication_mode.name}_'
...
send_mail_notification(scenario_description='simple demand response')
