...
from agent_communication_generation_tool.description_classes.agent_communication_pattern import WideAreaProtection
...
try:
                ...
                for specification in specifications:
                    ...
                    communication_graph = (
                        StarCommunicationGraph(agents=communication_network_description.agents,
                                               ...
                                               max_number_of_agents_per_type=max_number_of_agents_))
                    wap_communication_pattern = WideAreaProtection(simulation_duration_ms=SIMULATION_DURATION_MS,
                                                                   communication_graph=communication_graph)

                    communication_scenario_description = (
                        CommunicationScenarioDescription(description_text='wide_area_protection'
    ...
    send_mail_notification(scenario_description='simple WAP')
except Exception as e:
    send_mail_notification(scenario_description=f'simple WAP, error: {e}', failed=True)
