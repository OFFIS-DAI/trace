...
try:
    ...
    send_mail_notification(scenario_description='simple WAC stability control')
except Exception as e:
    send_mail_notification(scenario_description=f'simple WAC stability control, error: {e}', failed=True)
