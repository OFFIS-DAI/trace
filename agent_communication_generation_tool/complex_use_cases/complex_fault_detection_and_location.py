...
from agent_communication_generation_tool.description_classes.agent_communication_pattern import \
    FaultDetectionAndLocation, OrganizationalStructure
                            ...
                            for specification in specifications:
                                ...
                                communication_graph = (
                                    StarCommunicationGraph(agents=communication_network_description.agents,
                                                           ...
                                                           max_number_of_agents_per_type=max_number_of_agents_))
                                communication_pattern = FaultDetectionAndLocation(
                                ...
                                communication_scenario_description = (
                                    CommunicationScenarioDescription(
                                        description_text=f'fault_detection_and_location_CENTRALIZED_'
                                ...
                                communication_scenario_description = (
                                    CommunicationScenarioDescription(
                                        description_text=f'fault_detection_and_location_HIERARCHICAL_'
                                                         f'{data_size_generator_n}_'
                                                         f'complexity_{optimization_complexity}'
                                                         f'simbench_network_'
                                                         f'{communication_network_description.simbench_code},'
                                ...
                                for overlay_n, overlay in overlay_types(communication_network_description,
                                    ...
                                    communication_pattern = (
                                        FaultDetectionAndLocation(simulation_duration_ms=SIMULATION_DURATION_MS,
                                    ...
                                    communication_scenario_description = (
                                        CommunicationScenarioDescription(
                                            description_text=f'fault_detection_and_location_DECENTRALIZED_'
                                    ...
                                    communication_scenario_description.run_simulation()
    send_mail_notification(scenario_description='complex fault detection and location')
except Exception as e:
    send_mail_notification(scenario_description=f'complex fault detection and location, error: {e}', failed=True)
