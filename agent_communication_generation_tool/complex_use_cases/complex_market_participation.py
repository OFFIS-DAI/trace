...
SIMULATION_DURATION_MS = 15 * 60 * 1000  # 15 minutes

market_intervals = [random.choice([5 * 60 * 1000, 15 * 60 * 1000])]  # 5 minutes, 10 minutes
                                ...
                                for specification in specifications:
                                    ...
                                    for i_till_goal in num_iterations_till_goal:
                                        for overlay_n, overlay in overlay_types(communication_network_description,
                                            ...
                                            communication_scenario_description.run_simulation()
    send_mail_notification(scenario_description='complex market participation')
except Exception as e:
    send_mail_notification(scenario_description=f'complex market participation, error: {e}', failed=True)
